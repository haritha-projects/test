...
def prediction(request,city):
    ...
    if city=="THRISSUR":
        data_2023 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\AQI DATASET_2023_2022.xlsx", sheet_name='2023')
        data_2022 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\AQI DATASET_2023_2022.xlsx", sheet_name='2022')
        data_2022_2=pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\AQI DATASET_2023_2022.xlsx",sheet_name = '2022_AUG_DEC')
        ...
        datap_2022 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\plamood_aqi.xlsx", sheet_name='2022')
        datap_2023 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\plamood_aqi.xlsx", sheet_name='2023')
        ...
        datak_2022 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\karyavattom_aqi.xlsx", sheet_name='2022')
        datak_2023 = pd.read_excel(r"C:\Users\hp\Desktop\dataset_updated\karyavattom_aqi.xlsx", sheet_name='2023')
    ...
    if result>0 and result<=50:
        ...
        category="SEVERE"
    return render(request,"aqi_city.html",{'key':result,'status':category})


def state_page(request,status):
      if status == "GOOD":
